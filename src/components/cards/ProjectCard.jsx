  ...
  return (
    <div className="project-card w-auto border-2 border-gray-800">
      ...
      <div className="w-full h-auto p-4 flex justify-around m-auto">
        <a className='md:text-2xl' href={project.repo} onClick={()=>{project.repo? null : alert("Link Not Availabe!")}} target='_blank'>View on GitHub</a>
        <a className='md:text-2xl' href={project.weblink} onClick={()=>{project.weblink? null : alert("Link Not Availabe!")}} target='_blank'>Live Demo</a>
      </div>
